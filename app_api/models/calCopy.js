...
const intentCalViewSchema = new goo.Schema({
    context: { type: String, required: true },
    // times_of_day_bounds: { type: timeOfDayBoundsSchema, required: true },
    days: [{type: daySchema,required: true}]
});
const adheredCalViewSchema = new goo.Schema({
    context: { type: String, required: true },
    // activities: [{ type: activitySchema, required: true }]
});
...
const fortnightSchema = new goo.Schema({
    ...
    intent_cal_view: { type: intentCalViewSchema, required: true },
    adhered_cal_view: { type: adheredCalViewSchema, required: true },
    modes: [modeSchema],
